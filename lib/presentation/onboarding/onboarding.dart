import 'package:flut_all_content/presentation/onboarding/onboarding_viewmodel.dart';
...
class _OnBoardingViewState extends State<OnBoardingView> {
        ...
        bottomSheet: Container(
          ...
          child: Column(
            children: [
              ...
              //add layouts for indicator and arrows
  ...
  Widget _getProperCircle(int index, int _currentIndex) {
    if (index == _currentIndex) {
      return SvgPicture.asset(ImagesAssets.hollowCircleIc); //selected
    } else {
      return SvgPicture.asset(ImagesAssets.solidCircleIc); //un_selected
    }
  }
}
