...
class _AppServiceClient implements AppServiceClient {
  _AppServiceClient(this._dio, {this.baseUrl}) {
    baseUrl ??= 'https://cleancodearch.mocklab.io';
  }
  ...
  @override
  Future<AuthenticationResponse> register(userName, countryMobileCode, email,
  ...
  Future<HomeDetailsResponse> fetchHomeDetails() async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HomeDetailsResponse>(
  ...
  Future<SingleStoreDetailsResponse> fetchSingleStoreDetails() async {
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<SingleStoreDetailsResponse>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(_dio.options, '/singleStoreDetails/1',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = SingleStoreDetailsResponse.fromJson(_result.data!);
    return value;
  }
